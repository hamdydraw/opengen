...
class Order extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'affiliate_id','commission','marketing_id','tracking','language_id','currency_id','symbol_left','symbol_right','currency_code','currency_value','ip','forwarded_ip','user_agent'
    ];
