            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link active show" href="#timeline" data-toggle="tab">Timeline</a></li>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="texs"  v-model="form.name"  class="form-control" id="inputName" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group">
